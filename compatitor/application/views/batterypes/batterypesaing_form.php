<!-- Main content -->
            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  ...
                  <h3 class='box-title'>Pesaing Forklift Battery</h3>
        ...
        <tr><td>Vehicle Weight (kg)<?php echo form_error('vehicle') ?></td>
            <td><input type="text" class="form-control" name="vehicle" id="vehicle" placeholder="Vehicle Weight" value="<?php echo $vehicle; ?>" / >
        </td>
...
<!--	    <input type="hidden" name="Id_buku" value="<?php echo $Id_buku; ?>" /> -->
	    ...
	    <a href="<?php echo site_url('Batterypesaing') ?>" class="btn btn-default">Cancel</a></td></tr>
